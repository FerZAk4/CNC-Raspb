...
#User set variables
remdir = "/home/pi/Desktop/GCode"
address = "raspberrypi25"  #This will be an IP address if avahi-daemon is not installed (which I strongly reccommend
user = "pi"
password = "raspberrypi4z"
